...
(() => {
  ...
  var getEvents = () => {
    ...
    const events = [...scripts].map((script) => {
      ...
      } else if (event.getbyweekday.includes("su") === false && event.getbyweekday.includes("mo") === false && event.getbyweekday.includes("tu") === false && event.getbyweekday.includes("we") === false && event.getbyweekday.includes("th") === false && event.getbyweekday.includes("fr") === false && event.getbyweekday.includes("sa") === false) {
        event.rrule.byweekday = ["su,mo,tu,we,th,fr,sa"];
      ...
      } else if (event.repertoire === "\xC9v\xE8nements") {
